    ...
    <>
      ...
      <div>
        <div className="card long m-3">
            <img src="./images/companyLogos/JPMorgan.jpg" alt="JP"></img>
            <h5>Code For Good</h5>
            <br/>
            <h6>J.P Morgan</h6>
            <h6>Nov 2022</h6>
        ...
        <div className="card long m-3">
            <img src="./images/companyLogos/Polygon.jpg" alt="Polygon"></img>
        ...
        <div className="card long m-3">
            <img src="./images/companyLogos/Meta.png" alt="Meta"></img>
